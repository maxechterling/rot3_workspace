...
{
    # get input arguments
	my $rr       = shift;      # this reaction rule
	my $sg_list  = shift;      # refine rules w.r.t. these species graphs
	my $model    = shift;      # model
	my $hybrid_model = shift;  # new hybrid model
...
sub apply_to_reactants
{
    # get input arguments
    my $rr = shift;
    my $reactant_set = shift;
    my $model = shift;
    my $hybrid_model = shift;
    my $user_params = (@_) ? shift : {};
